        ...
        return (
            <PageContainer>
                ...
                <Top >
                    ...
                    <div className="nav">
                        <ul>
                            ...
                            <li onClick={this.props.handleDogFood.bind(this)}>进口狗粮</li>
                            <li>国产狗粮</li>
                            <li>内外驱虫</li>
                ...
                <Nav>
                    ...
                    <img onClick={this.props.handleEgroup.bind(this)} src="https://img2.epetbar.com/2019-11/15/23/3fe5bbce73f303015077ed7a827de61c.png@!water"/>
                    ...
                    <img onClick={this.props.handleClearGoods.bind(this)} src="https://img2.epetbar.com/2019-11/16/00/1ec58c7b09ad2baa80e57609d87b6244.png@!water"/>
                </Nav>
                {/* 图的组合 */}
                <Tu1>
                ...
                <Rushed>
                    <div className="zuo">
                        ...
                        <div className="zuohe" key={index}>
                            <div onClick={this.props.handleRobDay.bind(this)} className="zuozuo">
                                <img src={item.image.img_url}/>
                                <h6>￥{item.sale_price}</h6>
                                <h5><del>￥{item.little_price}</del></h5>
                            </div>
                        </div>
                        ))
                    }
